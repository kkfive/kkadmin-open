...
<script lang="ts">
  ...
  import { addFriendCircleLink, updateFriendCircle } from '/@/api/friend/friend';
      ...
      async function handleSubmit() {
        try {
          ...
          if (updateObject.value) {
            // 修改接口
            await updateFriendCircle({ _id: updateObject.value, ...values });
          } else {
            // 新增接口
            await addFriendCircleLink(values);
          }
          console.log(values);
          // 成功
          closeDrawer();
