...
export const columns: BasicColumn[] = [
  ...
  },
  {
    ...
    dataIndex: 'link',
    customRender: ({ record }) => {
      return h('a', { href: (record as any).link, target: 'target' }, '查看');
    },
  },
  {
    title: '标签',
  ...
  },
  {
    ...
    dataIndex: 'from',
    customRender: ({ record }) => {
      return h('span', {}, (record as any).from[0].userName);
    },
  },
  {
    title: 'to',
    dataIndex: 'to',
    customRender: ({ record }) => {
      return h('span', {}, (record as any).to[0].userName);
    },
  },
  {
    title: '状态',
...
export const formSchema: FormSchema[] = [
  ...
  {
    field: 'theme.hoverBgColor',
    label: '鼠标悬浮样式',
    component: 'Input',
    required: false,
  },
  {
    field: 'theme.hoverAvatarRotate',
    label: '头像旋转角度',
    component: 'Input',
    required: false,
  },
